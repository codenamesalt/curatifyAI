            ...
            {({params, setParams}) => (
                ...
                <div className="SearchBar">
                    <Autocomplete
                        ...
                        renderOption={(option) => (
                            <React.Fragment>
                                { option.img && <img src={option.img} width={32} height={32} alt="album cover"></img> }
                                &nbsp;
                        ...
                        autoHighlight
                        autoSelect
                        noOptionsText="Search for an Artist or Song..."
                        onInputChange={updateOptions}
                        filterOptions={(options, state) => options}
                        getOptionSelected={(option, value) => option }
                        renderInput={(params) => <TextField {...params} label="Pick a Song or Artist as a seed" variant="outlined"/>}
